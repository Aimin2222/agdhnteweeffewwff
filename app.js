const characters = [
  {
  ...
  },
   {
    ...
    anomalies: "究極のヒーロー, ブリー, ノックアウト, 最後のチャンス, シュリーマの遺産, 飽くなき食欲(HPあるなら), アルカナの圧倒（敵に魔法が多いなら）アルカナの圧倒（敵に魔法が多いなら）,  深い根（前中央に置く）	（前中央に置く）, 石の皮膚（できればワントップ）	（できればワントップ）, 茨の皮膚（できればワントップ）	（できればワントップ） "
  },
    {
    name: "ヴァイオレット",
    items:
