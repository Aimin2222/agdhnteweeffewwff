const characters = [
  {
  ...
  },
   {
    ...
    anomalies: "究極のヒーロー, ブリー, ノックアウト, 最後のチャンス, シュリーマの遺産, 飽くなき食欲(HPあるなら), アルカナの圧倒,  深い根, 石の皮膚, 茨の皮膚 "
  },
    {
    name: "ヴァイオレット",
    items:
  ...
  },
 {
  ...
  },
  {
    ...
    name: "ビクター",
    items:
      "盗賊のグローブ, レッドバフ or モレロノミコンs, ラバドンデスキャップ, ジャイアントスレイヤー, デスブレード, ジュエルガントレット, ホライゾン フォーカス",
    anomalies: "逆転劇, 魔法の達人"
  },
  {
    name: "メル",
